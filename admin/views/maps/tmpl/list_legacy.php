	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="5%" nowrap="nowrap">
					<?php echo JHTML::_('grid.sort', JText::_('Published'), 'published', $this->filter->filter_order_Dir, $this->filter->filter_order, 'filter'); ?>
				</th>
				...
				<th nowrap="nowrap">
					<?php echo JHTML::_('grid.sort', JText::_('Access'), 'access', $this->filter->filter_order_Dir, $this->filter->filter_order, 'filter'); ?>
				</th>
				<th>
					<?php echo JText::_('Map Description'); ?>
				</th>
				<th width="1%">
					<?php echo JText::_('ID'); ?>
				</th>
		...
		for($i=0; $i < count($this->items); $i++){
			...
			<tr class="row<?php echo $k; ?>">
				...
				<td class="order">
					<span><?php echo $this->page->orderUpIcon( $i, ($i > 0), 'maps.orderup', 'Move Up'); ?></span>
					<span><?php echo $this->page->orderDownIcon( $i, count($this->items), true, 'maps.orderdown', 'Move Down'); ?></span>
